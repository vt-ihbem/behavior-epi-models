...
tmax=400000;
[t,y] = ode45(@seir, [0:1:tmax], IC, [], p);
[t1,y1]=ode45(@seirs,[0:1:tmax], IC, [], p);
...
print(gcf,'Compare_SEIR_SEIRS_500.pdf','-dpdf','-r300');
saveas(h1,'Compare_SEIR_SEIRS_500.png');
...
ax.XAxis.FontSize = 24;
ax.YAxis.FontSize = 24;
print(gcf,'Compare_SEIR_SEIRS_equil.pdf','-dpdf','-r300');
saveas(h2,'Compare_SEIR_SEIRS_equil.png');
