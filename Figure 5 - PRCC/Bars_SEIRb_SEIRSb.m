...
load('LHS_PRCC_SEIRSb_output.mat','sortedPRCC_1','sortedPRCC_2','sortedPRCC_3','sortedstat_p1','sortedstat_p2','sortedstat_p3','sortedparams','pars')
...
load('LHS_PRCC_SEIRb_output.mat','sortedPRCC_1','sortedPRCC_2','sortedPRCC_3','sortedstat_p1','sortedstat_p2','sortedstat_p3')
sortedPRCC_1 = [sortedPRCC_1 0];
sortedPRCC_2 = [sortedPRCC_2 0];
sortedPRCC_3 = [sortedPRCC_3 0];
sortedstat_p1 = [sortedstat_p1 NaN]; 
sortedstat_p2 = [sortedstat_p2 NaN]; 
sortedstat_p3 = [sortedstat_p3 NaN]; 

% QOI_1: Maximum size of infectious population
h1=figure(1);
b = bar([sortedPRCC_1;SsortedPRCC_1]','FaceAlpha',.5);
% hold on
% plot(8,0,'xk','MarkerSize',24)
% hold off
...
saveas(h1,'QOI_1_SEIRb_SEIRSb.png')
...
saveas(h2,'QOI_2_SEIRb_SEIRSb.png')
...
saveas(h3,'QOI_3_SEIRb_SEIRSb.png')