...
p4tauR.beta = p.beta; 
p4tauR.a = p.a;
p4tauR.gamma=p.gamma;
p4tauR.tauE=p.tauE;
p4tauR.tauI=p.tauI;
p4tauR.tauF = p.tauF;
p4tauR.tauR = 150;

%% Initial Conditions and max time
S0 = 1-(20/10^6);
E0 = 10/10^6;
I0 = 10/10^6;
R0 = 0;
...
saveas(h1,'Change_beta_SEIRSb.png');
...
xlim([0,tmax]);
xlabel('Time (days)','FontSize',24)
ylabel('Infectious population size','FontSize',24)
...
ax.XAxis.FontSize = 24;
ax.YAxis.FontSize = 24;
saveas(h2,'Change_gamma_SEIRSb.png');
...
xlabel('Time (days)','FontSize',24)
ylabel('Infectious population size (i)','FontSize',24)
legend(sprintf('a = %g',p1a.a),sprintf('a = %g',p2a.a),...
        sprintf('a = %g',p.a),sprintf('a = %g',p3a.a),sprintf('a = %g',p4a.a),'FontSize',24)
legend boxoff
ax = gca;
ax.XAxis.FontSize = 24;
ax.YAxis.FontSize = 24;
saveas(h3,'Change_a_SEIRSb.png');
...
ax.XAxis.FontSize = 24;
ax.YAxis.FontSize = 24;
saveas(h4,'Change_tauE_SEIRSb.png');
...
ax.XAxis.FontSize = 24;
ax.YAxis.FontSize = 24;
saveas(h5,'Change_tauI_SEIRSb.png');
...
ax.XAxis.FontSize = 24;
ax.YAxis.FontSize = 24;
saveas(h6,'Change_tauF_SEIRSb.png')
...
legend(sprintf('\\tau_R = %g',p1tauR.tauR),sprintf('\\tau_R = %g',p2tauR.tauR),sprintf('\\tau_R = %g',p.tauR),...
       sprintf('\\tau_R = %g',p3tauR.tauR),sprintf('\\tau_R = %g',p4tauR.tauR),'FontSize',24)
legend boxoff
ax = gca;
ax.XAxis.FontSize = 24;
ax.YAxis.FontSize = 24;
saveas(h7,'Change_tauR_SEIRSb.png');
